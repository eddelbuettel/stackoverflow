...
template<size_t nparts, size_t num_bits, typename resamp_t, typename float_t, bool debug_mode = false>
class svol_sisr_hilb : public SISRFilterCRN<nparts, 1, 1, 1, 1, resamp_t, float_t, debug_mode>
{
public:
...
template<size_t nparts, size_t num_bits, typename resamp_t, typename float_t, bool debug_mode>
svol_sisr_hilb<nparts,num_bits,resamp_t,float_t,debug_mode>::svol_sisr_hilb(const float_t &phi, const float_t &beta, const float_t &sigma)
    : SISRFilterCRN<nparts, 1, 1, 1, 1, resamp_t, float_t,debug_mode>()
...
template<size_t nparts, size_t num_bits, typename resamp_t, typename float_t, bool debug_mode>
float_t svol_sisr_hilb<nparts,num_bits,resamp_t,float_t,debug_mode>::logMuEv (const ssv &x1 )
{
...
template<size_t nparts, size_t num_bits, typename resamp_t, typename float_t, bool debug_mode>
auto svol_sisr_hilb<nparts,num_bits,resamp_t,float_t,debug_mode>::Xi1(const usv& U, const osv &y1) -> ssv
{
...
template<size_t nparts, size_t num_bits, typename resamp_t, typename float_t, bool debug_mode>
float_t svol_sisr_hilb<nparts,num_bits,resamp_t,float_t,debug_mode>::logQ1Ev (const ssv &x1, const osv &y1)
{
    return rveval::evalUnivNorm<float_t>(x1(0), 0.0, m_sigma/std::sqrt(1.0 - m_phi*m_phi), true);
}
...
template<size_t nparts, size_t num_bits, typename resamp_t, typename float_t, bool debug_mode>
float_t svol_sisr_hilb<nparts,num_bits,resamp_t,float_t,debug_mode>::logGEv (const osv &yt, const ssv &xt)
{
...
template<size_t nparts, size_t num_bits, typename resamp_t, typename float_t, bool debug_mode>
float_t svol_sisr_hilb<nparts,num_bits,resamp_t,float_t,debug_mode>::logFEv(const ssv &xt, const ssv &xtm1)
{
...
template<size_t nparts, size_t num_bits, typename resamp_t, typename float_t, bool debug_mode>
auto svol_sisr_hilb<nparts,num_bits,resamp_t,float_t,debug_mode>::Xit(const ssv &xtm1, const usv& U, const osv &yt) -> ssv
{
...
template<size_t nparts, size_t num_bits, typename resamp_t, typename float_t, bool debug_mode>
float_t svol_sisr_hilb<nparts,num_bits,resamp_t,float_t,debug_mode>::logQEv(const ssv &xt, const ssv &xtm1, const osv &yt)
{
    return rveval::evalUnivNorm<float_t>(xt(0), m_phi * xtm1(0), m_sigma, true);
}
