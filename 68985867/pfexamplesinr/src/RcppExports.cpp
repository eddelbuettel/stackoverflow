...
RcppExport SEXP _pfexamplesinr_rcppeigen_outerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _pfexamplesinr_rcppeigen_innerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type x(xSEXP);
...
RcppExport SEXP _pfexamplesinr_rcppeigen_bothproducts(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type x(xSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_pfexamplesinr_rcppeigen_bothproducts", (DL_FUNC) &_pfexamplesinr_rcppeigen_bothproducts, 1},
    {NULL, NULL, 0}
};
